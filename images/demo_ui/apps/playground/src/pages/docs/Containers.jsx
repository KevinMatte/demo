    ...
    return (
        <div>
            ...
            <ul>
                ...
                <li><DemoAnchor title="PHP Server" path="images/demo_ui/apps/playground/src/static/var/www/html/hello_world.php"/></li>
                ...
                <li><DemoAnchor title="Python Server"
                                path="images/demo_ui/apps/playground/src/static/var/www/html/py_app/hello_world.py"/>
                </li>
